...
$ciencia_id=$_POST['username'];
    ...
    {
        $error_msg="The Ciencia Id You entered is Not Registered.Click here to Register. ";
        ...
        <div id="loginbox" style="margin-top:20px; width:50%;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div class="panel-title text-center no-botton-margin">Forgot Password</div>
...
<?php if($error_msg!="")
{
  ...
  <strong>Registerd Already!</strong>.The Ciencia Id You entered is Not Registered.Click here to<a href='preregister.php'> Regiter. </a>
                      </div>";
}
?>
                        ...
                        <form id="loginform" class="form-horizontal" role="form" action="pre_forgot_password.php" method="POST">
                                    
                            <div style="margin-bottom: 25px" class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="login-username" type="text" class="form-control" name="username" value="" placeholder="Ciencia Id">                                        
                                    </div>
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls text-center">
                                      <button id="btn-login" href="#" class="btn btn-success" type="submit">Forgot Password</button>
