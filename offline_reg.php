...
<div class="container" style="margin-top:50px;">
      <!-- Jumbotron -->
      <div class="jumbotron">
        <h1 class="text-center">Offline Registration Successful!</h1>
        <p class="text-center"><b><i>Please make the payment at Placement Cell, CVR College Of Engineering.</i></b></p>
        <p class="text-center"><b><i>Make sure you specify your Roll No. at the time of payment.</i></b></p>
      </div>
    </div>
