...
<div class="container" style="margin-top:50px;">
      <!-- Jumbotron -->
      <div class="jumbotron">
        <p class="text-center"><b><i>Login failed!</i></b></p>
         <p class="text-center"><b><i>The Ciencia Id or Password you've entered is incorrect. Please check and Login again.</i></b></p>
      </div>
    </div>
